...
First establish `HMD_HOME`; `nsctl` does not guess it. Read the environment
list and command help before choosing an environment. Explain the distinction
between the shared control plane and an environment's deployment state.
